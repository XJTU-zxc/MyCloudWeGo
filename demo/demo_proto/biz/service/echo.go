...
import (
	"context"
	pbapi "github.com/XJTU-zxc/MyCloudWeGo/demo/demo_proto/kitex_gen/pbapi"
)
...
func (s *EchoService) Run(req *pbapi.Request) (resp *pbapi.Response, err error) {
	...
	repeatedMessage := req.Message + req.Message
	return &pbapi.Response{Message: repeatedMessage}, nil
