...
func (p *EchoClient) Echo(ctx context.Context, request *Request) (r *Response, err error) {
...
var EchoEchoArgs_Request_DEFAULT *Request

func (p *EchoEchoArgs) GetRequest() (v *Request) {
	if !p.IsSetRequest() {
		return EchoEchoArgs_Request_DEFAULT
	}
	return p.Request
}
func (p *EchoEchoArgs) SetRequest(val *Request) {
	p.Request = val
}
...
func (p *EchoEchoArgs) IsSetRequest() bool {
