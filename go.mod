module github.com/XJTU-zxc/MyCloudWeGo

go 1.23.4

replace github.com/XJTU-zxc/MyCloudWeGo/demo/demo_proto => ./demo/demo_proto

require (
	github.com/XJTU-zxc/MyCloudWeGo/demo/demo_proto v0.0.0-00010101000000-000000000000
